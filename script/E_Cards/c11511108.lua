...
function s.initial_effect(c)
	--xyz summon
	Xyz.AddProcedure(c,aux.FilterBoolFunction(Card.IsSetCard,0x1ffe),4,2)
	c:EnableReviveLimit()
	--spsummon
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if e:GetLabel()==0 then
		tc=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_HAND+LOCATION_GRAVE,0,1,1,nil,e,tp)
	else
		tc=Duel.SelectMatchingCard(tp,s.spfilter,tp,LOCATION_DECK,0,1,1,nil,e,tp)
	end
	if tc then
