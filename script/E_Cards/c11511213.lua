...
function s.filterG(c,e,tp)
	...
	and Duel.IsExistingMatchingCard(s.filterSp,tp,LOCATION_DECK,0,1,nil,e,tp,c:GetLevel(),c:GetAttribute())
end
...
function s.spop(e,tp,eg,ep,ev,re,r,rp)
	...
	if Duel.SendtoGrave(tc,REASON_EFFECT) then
		...
		local g=Duel.SelectMatchingCard(tp,s.filterSp,tp,LOCATION_DECK,0,1,1,nil,e,tp,lv,att)
		if #g>0 then
